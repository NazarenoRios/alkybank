...
export default function Header({ title }) {
  ...
  return (
    <header className="w-full h-[100px] flex items-center justify-between px-5 box-border">
      ...
      { !darkMode ? <img src={alkybankLogo} className="mr-3 w-40 h-auto" alt="Alkemy bank Logo" /> : <img src={alkybankLogoWhite} className="mr-3 w-40 h-auto" alt="Alkemy bank Logo Black Mode" /> }
      </a>
