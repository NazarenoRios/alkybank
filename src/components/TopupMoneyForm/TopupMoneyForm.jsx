...
export default function TopupMoneyForm() {
  ...
  return (
    <div className="flex justify-center content-center ">
      ...
      */}
          {display && <div className="container px-6 h-full">
            <Tooltip display={display} isLoading={isLoading} setDisplay={setDisplay} message={"Topup Success"} status="success" />
          </div>
          }
              ...
              <div className="block bg-white dark:bg-dark2 shadow-lg rounded-lg">
                ...
                <div className="md:p-12 md:mx-6">
                  <div className="text-center">
                    <h1 className="dark:text-primary text-3xl p-5 flex  justify-center"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className=" w-12 h-12">
